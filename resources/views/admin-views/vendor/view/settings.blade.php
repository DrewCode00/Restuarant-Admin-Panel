                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.free_delivery')}}<span class="input-label-secondary" title="{{__('messages.free_delivery_toggle_hint')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.free_delivery_toggle_hint')}}"></span>:</span> 
